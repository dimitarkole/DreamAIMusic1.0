...
namespace DreamAIMusic.Tests.TestData
{
    public class SongTestData
    {
        ...
        {
            new Song(){ Id ="testSongId1", Name = "testSong1", Category =Categories[0], CategoryId = Categories[0].Id, ImageExtension =".img", Mp3Extension = ".mp3", Text = "some text", UniqueSongFilesName = "unique song file name", User = Users[0], UserId = Users[0].Id, Comments = new List<Comment>()},
        ...
        {
            new Comment(){ SongId = GetById, Text="comment1", User = Users[1], UserId = Users[1].Id},
            new Comment(){ SongId = GetById, Text="comment2", User = Users[1], UserId = Users[1].Id},
            new Comment(){ SongId = DeleteSongId, Text="comment3", User = Users[1], UserId = Users[1].Id},
            new Comment(){ SongId = GetById, Text="comment4", User = Users[1], UserId = Users[1].Id},
            new Comment(){ SongId = GetById, Text="comment5", User = Users[1], UserId = Users[1].Id},
        };
